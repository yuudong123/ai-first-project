...
COPY jenkins-init.groovy /usr/share/jenkins/ref/init.groovy.d/hydrotwin.groovy.override

# 기본 빌드 대상은 Python 애플리케이션이다.
FROM python:3.11-slim AS app
WORKDIR /app
ENV PYTHONUNBUFFERED=1 PYTHONPATH=/app KERAS_BACKEND=jax OMP_NUM_THREADS=2 OPENBLAS_NUM_THREADS=2
