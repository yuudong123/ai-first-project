...
| 9/7(월)~9/10(목) | 1차 시스템 통합 | FastAPI↔Unity 연결, 실제 예측 결과 반영 | RandomForest 최종 모델 선정 및 저장 | 실제 AI 모델 FastAPI 연결, Unity API 지원 | Jenkins CI/CD 구성, 자동 테스트·빌드 연결, MLflow 실험 기록·모델 버전 관리·재학습 데모 |
